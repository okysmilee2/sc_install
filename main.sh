...
clear;clear;clear
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "\033[96;1m              WELCOME TO SCRIPT D_SWARA VPN              \033[0m"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 3
# Valid Script
...
data_ip="https://raw.githubusercontent.com/daneshswara29/izin/main/ip"
checking_sc() {
...
clear
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/daneshswara29/izin/main/ip | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/daneshswara29/izin/main/ip | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
...
Exp1=$(curl https://raw.githubusercontent.com/daneshswara29/izin/main/ip | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/daneshswara29/sc/main/"
start=$(date +%s)
secs_to_human() {
...
echo "DSWARA VPN" > /etc/xray/username
echo ""
elif [[ $host == "2" ]]; then
...
clear
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/daneshswara29/izin/main/ip | grep $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/daneshswara29/izin/main/ip | grep $ipsaya | awk '{print $3}')
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://t.me/D_swara"},{"text":"Contack","url":"https://wa.me/6282380835972"}]]}'
...
wget raw.githubusercontent.com/daneshswara29/sc/main/Fls/limit.sh && chmod +x limit.sh && ./limit.sh
cd
...
function noobzvpn(){
clear
wget --no-check-certificate https://raw.githubusercontent.com/daneshswara29/sc/main/noobzvpns.zip
unzip noobzvpns.zip
cd noobzvpns
bash install.sh
rm noobzvpns.zip
...
wget -q -O /usr/bin/enc "https://raw.githubusercontent.com/daneshswara29/sc/main/Enc/encrypt" ; chmod +x /usr/bin/enc
7z x -pDswara12345 menu.zip
chmod +x menu/*
enc menu/*
